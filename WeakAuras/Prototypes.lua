  ...
  ["Combat Log"] = {
    ...
    args = {
      ...
      },
      {
        ...
        disabled = true,
        enable = function(trigger)
          trigger.use_sourceFlags = true
          if trigger.sourceFlags == NotInGroup or not trigger.sourceFlags then
            trigger.sourceFlags = "InGroup"
          end
          return trigger.use_sourceFlags
        end,
